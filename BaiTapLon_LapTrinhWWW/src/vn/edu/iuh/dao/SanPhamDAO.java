...
public class SanPhamDAO {
	...
	public List<SanPham> getAllSanPham() {
		...
		listSanPham = jdbcTemplate.query(sql, new RowMapper<SanPham>() {
			public SanPham mapRow(ResultSet rs, int rowNum) throws SQLException {
				SanPham sanPham = new SanPham(rs.getString(1), rs.getString(2), rs.getDouble(3), rs.getString(4),
	...
	public SanPham getSanPham(String maSanPham) {
		...
		SanPham sanPham = (SanPham) jdbcTemplate.queryForObject(sql, new Object[] { maSanPham },
				new RowMapper<SanPham>() {
					public SanPham mapRow(ResultSet rs, int rowNum) throws SQLException {
						SanPham sanPham = new SanPham(rs.getString(1), rs.getString(2), rs.getDouble(3),
	...
	public int save(SanPham sp) {
		String sql = "INSERT INTO SanPham(maSanPham,tenSanPham,donGia,urlHinhAnh,moTa,tinhTrang,soLuongTon,loaiSanPham) "
				+ "values('" + sp.getMaSanPham() + "','" + sp.getTenSanPham() + "'," + sp.getDonGia() + ",'"
